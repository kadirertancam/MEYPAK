...
namespace MEYPAK.WEB.Controllers
{
    public class CEKSENETDURUMController : Controller
    {
        ...
        #region MusteriCekSenetDurum

        public IActionResult MusteriCekSenetDurum()
        {
            return View();
        }

        public List<CekDurum> MusteriCekSenetDurumRaporla()
        {
        ...
        #region FirmaCekSenetDurum
        public IActionResult FirmaCekSenetDurum()
        {
            return View();
        }

        public List<CekDurum> FirmaCekSenetDurumRaporla()
        {
            DateTime AyIlk = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1);
            DateTime AySon = AyIlk.AddMonths(1).AddDays(-1).AddHours(23).AddMinutes(59).AddSeconds(59);
            DateTime HaftaninIlkGunu, HaftaninSonGunu;
