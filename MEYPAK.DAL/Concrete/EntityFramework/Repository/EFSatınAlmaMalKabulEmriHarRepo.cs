...
namespace MEYPAK.DAL.Concrete.EntityFramework.Repository
{
    public class EFSatınAlmaMalKabulEmriHarRepo : EFBaseRepo<MPSATINALMAMALKABULEMRIHAR>,ISatinAlmaMalKabulEmriHarDal
    {
        ...
        public MPSATINALMAMALKABULEMRIHAR EkleyadaGuncelle(MPSATINALMAMALKABULEMRIHAR entity)
        {
            ...
            bool exists = context.MPSATINALMAMALKABULEMRIHAR.Any(x => x.ID == entity.ID);
            if (!exists)
            {
                context.MPSATINALMAMALKABULEMRIHAR.Add(entity);
                context.SaveChanges();
                return entity;
            }
            else
            {
                ...
                context.MPSATINALMAMALKABULEMRIHAR.Add(item);
                context.SaveChanges();
                context.ChangeTracker.Clear();
                ...
                context.MPSATINALMAMALKABULEMRIHAR.Update(entity);
                context.SaveChanges();
                return entity;
            }
        }
