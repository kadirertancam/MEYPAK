...
namespace MEYPAK.DAL.Concrete.EntityFramework.Repository
{
    public class EFCariDokumanRepo : EFBaseRepo<MPCARIDOKUMAN>, ICariDokumanDal
    {
        ...
        public EFCariDokumanRepo(MEYPAKContext _context) : base(_context)
        {
            ...
            {
                bool exists = context.MPCARIDOKUMAN.Any(x => x.ID == entity.ID);
                if (!exists)
                {
                    context.MPCARIDOKUMAN.Add(entity);
                    context.SaveChanges();
                    return entity;
                }
                else
                {
                    ...
                    context.MPCARIDOKUMAN.Add(item);
                    context.SaveChanges();
                    ...
                    context.MPCARIDOKUMAN.Update(entity);
                    context.SaveChanges();
                    return entity;
                }
            }
