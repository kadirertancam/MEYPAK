...
namespace MEYPAK.DAL.Concrete.EntityFramework.Repository.FaturaRepo
{
    public class EFFaturaDetayRepo: EFBaseRepo<MPFATURADETAY>, IFaturaDetayDal
    {
        ...
        public MPFATURADETAY EkleyadaGuncelle(MPFATURADETAY entity)
        {
            bool exists = _context.MPFATURADETAY.Any(x => x.ID == entity.ID);

            if (!exists)
            {
                _context.MPFATURADETAY.Add(entity);
            ...
            else
            {
                ...
                _context.MPFATURADETAY.Add(item);
                _context.SaveChanges();
                ...
                _context.MPFATURADETAY.Update(entity);
                _context.SaveChanges();
                return entity;
            }
        }
