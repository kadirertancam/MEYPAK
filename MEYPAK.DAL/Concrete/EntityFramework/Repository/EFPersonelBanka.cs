...
namespace MEYPAK.DAL.Concrete.EntityFramework.Repository
{
    public class EFPersonelBanka : EFBaseRepo<MPPERSONELBANKA>, IPersonelBankaDal
    {
        ...
        public MPPERSONELBANKA EkleyadaGuncelle(MPPERSONELBANKA entity)
        {
            ...
            bool exists = _context.MPPERSONELBANKA.Any(x => x.ID == entity.ID);
            if (!exists)
            {
                _context.MPPERSONELBANKA.Add(entity);
            ...
            else
            {
                ...
                _context.MPPERSONELBANKA.Add(item);
                _context.SaveChanges();
                ...
                _context.MPPERSONELBANKA.Update(entity);
                _context.SaveChanges();
                return entity;
            }
        }
