...
namespace MEYPAK.DAL.Concrete.EntityFramework.Repository.PersonelRepo
{
    public class EFPersonelGorevRepo : EFBaseRepo<MPPERSONELGOREV>, IPersonelGorevDal
    {
        ...
        {
            bool exists = _context.MPPERSONELGOREV.Any(x => x.ID == entity.ID);
            if (!exists)
            {
                _context.MPPERSONELGOREV.Add(entity);
            ...
            else
            {
                ...
                _context.MPPERSONELGOREV.Add(item);
                _context.SaveChanges();
                ...
                _context.MPPERSONELGOREV.Update(entity);
                _context.SaveChanges();
                return entity;
            }
        }
