...
namespace MEYPAK.DAL.Concrete.EntityFramework.Repository.PersonelRepo
{
    public class EFPersonelZimmetRepo : EFBaseRepo<MPPERSONELZIMMET>, IPersonelZimmetDal
    {
        ...
        {
            bool exists = _context.MPPERSONELZIMMET.Any(x => x.ID == entity.ID);
            if (!exists)
            {
                _context.MPPERSONELZIMMET .Add(entity);
            ...
            else
            {
                ...
                _context.MPPERSONELZIMMET.Add(item);
                _context.SaveChanges();
                ...
                _context.MPPERSONELZIMMET.Update(entity);
                _context.SaveChanges();
                return entity;
            }
        }
