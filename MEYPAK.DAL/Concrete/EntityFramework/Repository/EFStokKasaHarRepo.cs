...
namespace MEYPAK.DAL.Concrete.EntityFramework.Repository
{
    public class EFStokKasaHarRepo : EFBaseRepo<MPSTOKKASAHAR>, IStokKasaHarDal
    {
        ...
        {
            bool exists = _context.MPSTOKKASAHAR.Any(x => x.ID == entity.ID);
            if (!exists)
            {
                _context.MPSTOKKASAHAR.Add(entity);
            ...
            else
            {
                ...
                _context.MPSTOKKASAHAR.Add(item);
                _context.SaveChanges();
                ...
                _context.MPSTOKKASAHAR.Update(entity);
                _context.SaveChanges();
                return entity;
            }
        }
