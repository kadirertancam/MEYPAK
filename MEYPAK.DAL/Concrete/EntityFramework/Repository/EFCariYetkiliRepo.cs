...
namespace MEYPAK.DAL.Concrete.EntityFramework.Repository
{
    ...
    { 
        ...
        {
            bool exists = _context.MPCARIYETKILI.Any(x => x.ID == entity.ID);
            if (!exists)
            {
                _context.MPCARIYETKILI.Add(entity);
            ...
            else
            {
                ...
                _context.MPCARIYETKILI.Add(item);
                _context.SaveChanges();
                ...
                _context.MPCARIYETKILI.Update(entity);
                _context.SaveChanges();
                return entity;
            }
        }
