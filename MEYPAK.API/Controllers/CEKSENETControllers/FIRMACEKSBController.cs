...
namespace MEYPAK.API.Controllers.CEKSENETControllers
{
    [ApiController]
    [Route("[controller]")]
    public class FIRMACEKSBController : Controller
    {
        private readonly IMapper _mapper;
        private readonly IFirmaCekSBServis _FCekHarServis;
        private MPAdoContext<MPFIRMACEKSB> _adobankaServis = new MPAdoContext<MPFIRMACEKSB>();
        public FIRMACEKSBController(IMapper mapper, IFirmaCekSBServis FCekHarServis)
        {
            _mapper = mapper;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult EkleyadaGuncelle([FromBody] PocoFIRMACEKSB pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Sil(List<PocoFIRMACEKSB> pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Guncelle(PocoFIRMACEKSB pModel)
        {
            try
            {
