...
namespace MEYPAK.API.Controllers.CEKSENETControllers
{
    [ApiController]
    [Route("[controller]")]
    public class MUSTERISENETNOController : Controller
    {
        private readonly IMapper _mapper;
        private readonly IMusteriSenetNoServis _FCekHarServis;
        private MPAdoContext<MPMUSTERISENETNO> _adobankaServis = new MPAdoContext<MPMUSTERISENETNO>();
        public MUSTERISENETNOController(IMapper mapper, IMusteriSenetNoServis FCekHarServis)
        {
            _mapper = mapper;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult EkleyadaGuncelle([FromBody] PocoMUSTERISENETNO pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Sil(List<PocoMUSTERISENETNO> pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Guncelle(PocoMUSTERISENETNO pModel)
        {
            try
            {
