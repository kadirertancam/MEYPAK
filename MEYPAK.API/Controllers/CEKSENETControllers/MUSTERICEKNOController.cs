...
namespace MEYPAK.API.Controllers.CEKSENETControllers
{
    ...
    [Route("[controller]")]
    [Authorize]
    public class MUSTERICEKNOController : Controller
    {
        private readonly IMapper _mapper;
        private readonly IMusteriCekNoServis _FCekHarServis;
        private MPAdoContext<MPMUSTERICEKNO> _adobankaServis = new MPAdoContext<MPMUSTERICEKNO>();
        public MUSTERICEKNOController(IMapper mapper, IMusteriCekNoServis FCekHarServis)
        {
            _mapper = mapper;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult EkleyadaGuncelle([FromBody] PocoMUSTERICEKNO pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Sil(List<PocoMUSTERICEKNO> pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Guncelle(PocoMUSTERICEKNO pModel)
        {
            try
            {
