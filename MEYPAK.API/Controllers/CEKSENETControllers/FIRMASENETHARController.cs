...
namespace MEYPAK.API.Controllers.CEKSENETControllers
{
    ...
    [Route("[controller]")]
    [Authorize]
    public class FIRMASENETHARController : Controller
    {
        private readonly IMapper _mapper;
        private readonly IFirmaSenetHarServis _FCekHarServis;
        private MPAdoContext<MPFIRMASENETHAR> _adobankaServis = new MPAdoContext<MPFIRMASENETHAR>();
        public FIRMASENETHARController(IMapper mapper, IFirmaSenetHarServis FCekHarServis)
        {
            _mapper = mapper;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult EkleyadaGuncelle([FromBody] PocoFIRMASENETHAR pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Sil(List<PocoFIRMASENETHAR> pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Guncelle(PocoFIRMASENETHAR pModel)
        {
            try
            {
