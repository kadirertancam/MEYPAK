...
namespace MEYPAK.API.Controllers.CEKSENETControllers
{
    ...
    [Route("[controller]")]
    [Authorize]
    public class MUSTERICEKSENETController : Controller
    {
          private readonly IMapper _mapper;
        private readonly IMusteriCekSenetServis _FCekHarServis;
        private MPAdoContext<MPMUSTERICEKSENET> _adobankaServis = new MPAdoContext<MPMUSTERICEKSENET>();
        public MUSTERICEKSENETController(IMapper mapper, IMusteriCekSenetServis FCekHarServis)
        {
            _mapper = mapper;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult EkleyadaGuncelle([FromBody] PocoMUSTERICEKSENET pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Sil(List<PocoMUSTERICEKSENET> pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Guncelle(PocoMUSTERICEKSENET pModel)
        {
            try
            {
