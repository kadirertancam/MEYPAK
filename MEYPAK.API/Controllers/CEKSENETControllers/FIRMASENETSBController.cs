...
namespace MEYPAK.API.Controllers.CEKSENETControllers
{
    ...
    public class FIRMASENETSBController : Controller
    {
        ...
        private readonly IFirmaSenetSBServis _FCekHarServis;
        private MPAdoContext<MPFIRMASENETSB> _adobankaServis = new MPAdoContext<MPFIRMASENETSB>();
        public FIRMASENETSBController(IMapper mapper, IFirmaSenetSBServis FCekHarServis)
        {
            _mapper = mapper;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult EkleyadaGuncelle([FromBody] PocoFIRMASENETSB pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Sil(List<PocoFIRMASENETSB> pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Guncelle(PocoFIRMASENETSB pModel)
        {
            try
            {
