...
namespace MEYPAK.API.Controllers.CEKSENETControllers
{
    ...
    [Route("[controller]")]
    [Authorize]
    public class MUSTERISENETSBController : Controller
    {
        private readonly IMapper _mapper;
        private readonly IMusteriSenetSBServis _FCekHarServis;
        private MPAdoContext<MPMUSTERISENETSB> _adobankaServis = new MPAdoContext<MPMUSTERISENETSB>();
        public MUSTERISENETSBController(IMapper mapper, IMusteriSenetSBServis FCekHarServis)
        {
            _mapper = mapper;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult EkleyadaGuncelle([FromBody] PocoMUSTERISENETSB pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Sil(List<PocoMUSTERISENETSB> pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Guncelle(PocoMUSTERISENETSB pModel)
        {
            try
            {
