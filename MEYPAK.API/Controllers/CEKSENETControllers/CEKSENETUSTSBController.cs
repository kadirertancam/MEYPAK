...
namespace MEYPAK.API.Controllers.CEKSENETControllers
{
    ...
    [Route("[controller]")]
    [Authorize]
    public class CEKSENETUSTSBController : Controller
    {
        private readonly IMapper _mapper;
        private readonly ICekSenetUstSBServis _FCekHarServis;
        private MPAdoContext<MPCEKSENETUSTSB> _adobankaServis = new MPAdoContext<MPCEKSENETUSTSB>();
        public CEKSENETUSTSBController(IMapper mapper, ICekSenetUstSBServis FCekHarServis)
        {
            _mapper = mapper;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult EkleyadaGuncelle([FromBody] PocoCEKSENETUSTSB pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Sil(List<PocoCEKSENETUSTSB> pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Guncelle(PocoCEKSENETUSTSB pModel)
        {
            try
            {
