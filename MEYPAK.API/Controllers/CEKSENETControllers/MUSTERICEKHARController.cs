...
namespace MEYPAK.API.Controllers.CEKSENETControllers
{
    ...
    [Route("[controller]")]
    [Authorize]
    public class MUSTERICEKHARController : Controller
    {
        private readonly IMapper _mapper;
        private readonly IMusteriCekHarServis _FCekHarServis;
        private MPAdoContext<MPMUSTERICEKHAR> _adobankaServis = new MPAdoContext<MPMUSTERICEKHAR>();
        public MUSTERICEKHARController(IMapper mapper, IMusteriCekHarServis FCekHarServis)
        {
            _mapper = mapper;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult EkleyadaGuncelle([FromBody] PocoMUSTERICEKHAR pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Sil(List<PocoMUSTERICEKHAR> pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Guncelle(PocoMUSTERICEKHAR pModel)
        {
            try
            {
