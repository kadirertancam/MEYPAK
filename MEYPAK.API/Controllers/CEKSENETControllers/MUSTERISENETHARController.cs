...
namespace MEYPAK.API.Controllers.CEKSENETControllers
{
    ...
    [Route("[controller]")]
    [Authorize]
    public class MUSTERISENETHARController : Controller
    {
        private readonly IMapper _mapper;
        private readonly IMusteriSenetHarServis _FCekHarServis;
        private MPAdoContext<MPMUSTERISENETHAR> _adobankaServis = new MPAdoContext<MPMUSTERISENETHAR>();
        public MUSTERISENETHARController(IMapper mapper, IMusteriSenetHarServis FCekHarServis)
        {
            _mapper = mapper;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult EkleyadaGuncelle([FromBody] PocoMUSTERISENETHAR pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Sil(List<PocoMUSTERISENETHAR> pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Guncelle(PocoMUSTERISENETHAR pModel)
        {
            try
            {
