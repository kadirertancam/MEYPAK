...
namespace MEYPAK.API.Controllers.MUSTAHSILControllers
{
    ...
    [Route("[controller]")]
    [Authorize]
    public class MUSTAHSILCARIHARController : Controller
    {
        private readonly IMapper _mapper;
        private readonly IMustahsilCariHarServis _kasaServis;
        private MPAdoContext<MPMUSTAHSILCARIHAR> _adokasaservis = new MPAdoContext<MPMUSTAHSILCARIHAR>();
        public MUSTAHSILCARIHARController(IMapper mapper, IMustahsilCariHarServis kasaServis)
        {
            _mapper = mapper;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult EkleyadaGuncelle(PocoMUSTAHSILCARIHAR pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Sil(List<PocoMUSTAHSILCARIHAR> pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Guncelle(PocoMUSTAHSILCARIHAR pModel)
        {
            try
            {
