...
namespace MEYPAK.API.Controllers.MUSTAHSILControllers
{
    ...
    [Route("[controller]")]
    [Authorize]
    public class MUSTAHSILController : Controller
    {
        private readonly IMapper _mapper;
        private readonly IMustahsilServis _kasaServis;
        private MPAdoContext<MPMUSTAHSIL> _adokasaservis = new MPAdoContext<MPMUSTAHSIL>();
        public MUSTAHSILController(IMapper mapper, IMustahsilServis kasaServis)
        {
            _mapper = mapper;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult EkleyadaGuncelle(PocoMUSTAHSIL pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Sil(List<PocoMUSTAHSIL> pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Guncelle(PocoMUSTAHSIL pModel)
        {
            try
            {
