...
namespace MEYPAK.API.Controllers.MUSTAHSILControllers
{
    ...
    [Route("[controller]")]
    [Authorize]
    public class MUSTAHSILCARIController : Controller
    {
        private readonly IMapper _mapper;
        private readonly IMustahsilCariServis _kasaServis;
        private MPAdoContext<MPMUSTAHSILCARI> _adokasaservis = new MPAdoContext<MPMUSTAHSILCARI>();
        public MUSTAHSILCARIController(IMapper mapper, IMustahsilCariServis kasaServis)
        {
            _mapper = mapper;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult EkleyadaGuncelle(PocoMUSTAHSILCARI pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Sil(List<PocoMUSTAHSILCARI> pModel)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Guncelle(PocoMUSTAHSILCARI pModel)
        {
            try
            {
