...
{
    public partial class FMusteriSenetTeminat : XtraForm
    {
        public FMusteriSenetTeminat()
        {
            InitializeComponent();
        }
        #region TANIM
        ...
        void GridiDoldur()
        {
            DGMSenetTeminat.DataSource = _tempCariListe.Select(x => new
            {
                x.BORDRONO,
                x.SENETNO,
                x.TUTAR,
