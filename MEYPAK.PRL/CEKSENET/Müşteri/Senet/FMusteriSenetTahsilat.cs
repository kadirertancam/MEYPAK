...
{
    public partial class FMusteriSenetTahsilat : XtraForm
    {
        public FMusteriSenetTahsilat()
        {
            InitializeComponent();
        }
        ...
        void GridiDoldur()
        {
            DGMSenetTahsilat.DataSource = _tempCariListe.Select(x => new
            {
                x.BORDRONO,
                x.SENETNO,
                x.TUTAR,
