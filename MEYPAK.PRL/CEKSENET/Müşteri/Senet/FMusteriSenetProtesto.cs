...
{
    public partial class FMusteriSenetProtesto : XtraForm
    {
        public FMusteriSenetProtesto()
        {
            InitializeComponent();
        }
        #region TANIM
        ...
        void GridiDoldur()
        {
            DGMSenetProtesto.DataSource = _tempCariListe.Select(x => new
            {
                x.BORDRONO,
                x.SENETNO,
                x.TUTAR,
        ...
        private void BTKaydet_Click(object sender, EventArgs e)
        {
            if (_tempCariListe.Count() > 0)
            {
                ...
                MessageBox.Show("Senet eklemeden Protesto edemezsiniz!");
        }
    }
}
