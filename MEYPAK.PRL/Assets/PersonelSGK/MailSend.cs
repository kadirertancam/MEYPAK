...
{
	[DataContract(Name="MailSend", Namespace="http://schemas.datacontract.org/2004/07/HizliWebApp.Services")]
	[DebuggerStepThrough]
	[GeneratedCode("System.Runtime.Serialization", "4.0.0.0")]
	[Serializable]
	public class MailSend : INotifyPropertyChanged, IExtensibleDataObject
	{
		[NonSerialized]
		...
		public string Ettn
		{
			...
			set
			{
				if (!object.ReferenceEquals(this.EttnField, value))
				{
