...
{
	[DataContract(Name="InputDespatchAdviceModel", Namespace="http://schemas.datacontract.org/2004/07/HizliWebApp.Services")]
	[DebuggerStepThrough]
	[GeneratedCode("System.Runtime.Serialization", "4.0.0.0")]
	[Serializable]
	public class InputDespatchAdviceModel : INotifyPropertyChanged, IExtensibleDataObject
	{
		[NonSerialized]
		...
		[OptionalField]
		private Irsaliye irsaliyeField;
		...
		public Irsaliye irsaliye
		{
			...
			set
			{
				if (!object.ReferenceEquals(this.irsaliyeField, value))
				{
		...
		public InputDespatchAdviceModel()
		{
		}
