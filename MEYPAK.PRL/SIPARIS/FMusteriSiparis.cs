...
namespace MEYPAK.PRL.SIPARIS
{
    public partial class FMusteriSiparis : Form
    {
        ...
        void temizle()
        {
            DGMusteriSiparis.DataSource = "";
            _tempSiparisDetay.Clear();
            _tempSiparisDetay.Add(new PocoSiparisKalem());
            DGMusteriSiparis.DataSource = _tempSiparisDetay;
        ...
        void DataGridYapilandir()
        {
            ...
            DGMusteriSiparis.RepositoryItems.Add(repositoryItemButtonEdit);
            DGMusteriSiparis.RepositoryItems.Add(repositoryItemButton2);
            DGMusteriSiparis.RepositoryItems.Add(repositoryItemButtonEdit3);
        ...
        private void TBSiparisNo_Properties_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            ...
            if (_tempSiparis != null)
            {
                ...
                DGMusteriSiparis.DataSource = _siparisDetayServis.obje.Select(x => new PocoSiparisKalem()
                {
                    StokId = x.stokid,
