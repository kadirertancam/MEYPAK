...
namespace MEYPAK.PRL.SIPARIS
{
    public partial class FSatinAlmaSiparis : Form
    {
        ...
        List<PocoSiparisKalem> _tempIrsaliyeDetay = new List<PocoSiparisKalem>();
        ...
        void temizle()
        {
            ...
            _kasaaa.Clear();
            _tempIrsaliyeDetay.Add(new PocoSiparisKalem());
        ...
        void DataGridYapilandir()
        {
            ...
            _tempIrsaliyeDetay.Add(new PocoSiparisKalem() { Tipi = "STOK" });
            GCIrsaliye.DataSource = _tempIrsaliyeDetay;
        ...
        void Doldur()
        {
            if (_tempSIPARIS != null)
            {
                ...
                _tempIrsaliyeDetay.AddRange(_siparisDetayServis.obje.Select(x => new PocoSiparisKalem()
                {
                    id = x.id,
        ...
        private void RepositoryItemButtonEdit5_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            if (gridView1.GetFocusedRowCellValue("Tipi") == "STOK")
            {
                ...
                {
                    FStokOlcuBrList aa = new FStokOlcuBrList(this.Tag.ToString(), "FSatinAlmaSiparis", Convert.ToInt32(gridView1.GetFocusedRowCellValue("StokId")));
                    aa.ShowDialog();
                }
                else
                {
        ...
        private void RepositoryItemButtonEdit3_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            if (gridView1.GetFocusedRowCellValue("Tipi") == "STOK")
            {
                if (_kasaaa.Where(x => x.num.ToString() == gridView1.FocusedRowHandle.ToString()).Count() > 0)
                {
                    ...
                    fKasaList = new FStokKasaList(this.Tag.ToString(), "FSatinAlmaSiparis", gridView1.FocusedRowHandle.ToString(), _kasaaa);
                }
                else
                {
                    fKasaList = new FStokKasaList(this.Tag.ToString(), "FSatinAlmaSiparis", gridView1.FocusedRowHandle.ToString());
                }
        ...
        private void RepositoryItemButtonEdit_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            ...
            if (gridView1.GetFocusedRowCellValue("Tipi") == "STOK")
            {
                ...
                _fStokList = new FStokList(this.Tag.ToString(), "FSatinAlmaSiparis");
            ...
            else if (gridView1.GetFocusedRowCellValue("Tipi") == "KASA")
            {
                ...
                _fStokKasaList = new FStokKasaList(this.Tag.ToString(), "FSatinAlmaSiparis");
            ...
            {
                _fHizmetList = new FHizmetList(this.Tag.ToString(), "FSatinAlmaSiparis");
        ...
        private void BTKaydet_Click_1(object sender, EventArgs e)
        {
            ...
            if (_cariKart.obje.Where(x => x.kod == TBCariKodu.Text).Count() > 0)
            {
                _siparisServis.Data(ServisList.SiparisEkleServis, new PocoSIPARIS()
                {
                    ...
                    istkontotoplam = Convert.ToDecimal(TBIskontoToplam.Text), //_tempIrsaliyeDetay.Sum(x => x.İskontoTutarı),
        ...
        private void gridView1_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                num++;
                _tempIrsaliyeDetay.Add(new PocoSiparisKalem() { sıra = num });
                GCIrsaliye.DataSource = _tempIrsaliyeDetay;
        ...
        {
            FMusteriSiparisList ffaturalist = new FMusteriSiparisList(this.Tag.ToString(), "FSatinAlmaSiparis");
        ...
        private void TBCariKodu_Properties_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            ...
            _fCariList = new FCariList(this.Tag.ToString(), "FSatinAlmaSiparis");
