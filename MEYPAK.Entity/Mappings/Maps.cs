...
namespace MEYPAK.Entity.Mappings
{
    public class Maps:Profile
    {
        public Maps()
        {
            ...
            //GIDENFATURA
            CreateMap<MPGIDENIRSALIYELER, PocoGIDENIRSALIYELER>().ReverseMap(); 

            //GIDENFATURA
            CreateMap<MPGIDENFATURALAR, PocoGIDENFATURA>().ReverseMap(); 
            ...
            CreateMap<MPPERSONELBELGE, PocoPERSONELBELGE>().ReverseMap();
            ...
            CreateMap<MPARACZIMMET, PocoARACZIMMET>().ReverseMap();
            CreateMap<MPARACBELGE, PocoARACBELGE>().ReverseMap();
